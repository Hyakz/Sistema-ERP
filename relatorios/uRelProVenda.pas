...
type
    ...
    RLLabel12: TRLLabel;
    RLDraw3: TRLDraw;
    zqryQryItensVendavendaID: TIntegerField;
    zqryQryItensVendaprodutoID: TIntegerField;
    wdstrngfldQryItensVendanome: TWideStringField;
    fltfldQryItensVendaquantidade: TFloatField;
    fltfldQryItensVendavalorUnitario: TFloatField;
    fltfldQryItensVendatotalProduto: TFloatField;
